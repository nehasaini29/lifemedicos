...
<div class="modal-content content" style="margin-top:20px; margin-bottom:20px;">
	...
	$querycart="select p.*,c.* from cart c join product p on c.prod_id=p.prod_id where user_id=$id";
...
$paypal_id='nehasaini2941998@gmail.com'; // Business email ID
?>
 <div class="btn">
